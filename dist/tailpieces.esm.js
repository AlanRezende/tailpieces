...
class Form {
  ...
  clearErrors(data = this.data) {
    Object.entries(data).forEach(([key, value]) => {
      if (typeof value.value == "object" && value.value != null && !(value.value instanceof Blob) && !(value.value instanceof Date)) {
  ...
  setRules(rules, data = this.data) {
    ...
    Object.entries(rules).forEach(([key, value]) => {
      if (data[key] && typeof value == "string") {
        ...
        if (temp && typeof value == "object" && typeof temp.value == "object" && temp.value != null && !(temp.value instanceof Blob) && !(temp.value instanceof Date)) {
  ...
  addProperties(data) {
    ...
    const newObj = {};
    Object.entries(data).forEach(([key, value]) => {
      if (typeof value == "object" && value != null && !(value instanceof Blob) && !(value instanceof Date)) {
        const nested = [];
        value.forEach(item => {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_t_modal, {
    ...
    default: withCtx(() => [createVNode("div", _hoisted_1$2, [createVNode("div", _hoisted_2$2, [_hoisted_3$2, createVNode("div", _hoisted_4$2, [createVNode("h3", _hoisted_5$2, [renderSlot(_ctx.$slots, "title")]), createVNode("div", _hoisted_6$2, [renderSlot(_ctx.$slots, "content")])])])]), createVNode("div", _hoisted_7$2, [renderSlot(_ctx.$slots, "footer")])]),
    _: 3
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("table", _hoisted_1$1, [createVNode("thead", {
  ...
  }, null, 42, ["checked"])], 2)) : createCommentVNode("", true), (openBlock(true), createBlock(Fragment, null, renderList(_ctx.colunas.filter(col => !col.abaixo), coluna => {
  ...
  }), 128))])], 2), (openBlock(true), createBlock(Fragment, null, renderList(_ctx.value, (item, index) => {
    ...
    }, null, 42, ["onChange", "checked"])], 2)) : createCommentVNode("", true), (openBlock(true), createBlock(Fragment, null, renderList(_ctx.colunas.filter(col => !col.abaixo), coluna => {
    ...
    }), 128))], 10, ["onClick"]), _ctx.colunas.filter(col => !!col.abaixo).length > 0 ? (openBlock(), createBlock("tr", _hoisted_5$1, [(openBlock(true), createBlock(Fragment, null, renderList(_ctx.colunas.filter(col => !!col.abaixo && (typeof col.showCallback === 'function' ? col.showCallback(item) : true)), coluna => {
      return openBlock(), createBlock("td", {
        key: `coluna-${coluna.key}`,
        class: ["w-full text-gray-800 dark:text-gray-200 border border-b items-center relative", `${_ctx.size == 'sm' && 'p-1'} ${_ctx.size == 'base' && 'p-3'} `],
        colspan: coluna.colspan || 1
      }, [createVNode("div", _hoisted_6$1, [createVNode("span", _hoisted_7$1, toDisplayString(coluna.label), 1), createVNode("div", _hoisted_8$1, [renderSlot(_ctx.$slots, coluna.key, {
        $item: item
      }, () => [createTextVNode(toDisplayString(_ctx.checkItem(item[coluna.key])), 1)])])])], 10, ["colspan"]);
    }), 128))])) : createCommentVNode("", true)]);
  }), 128))]);
}
