  ...
  setup: function setup(props) {
    ...
    var colorClass = vue.computed(function () {
      ...
      var options = {
        ...
        yellow: "bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-700",
        green: "bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-800",
  ...
  _createClass(Form, [{
    ...
    value: function clearErrors() {
      ...
      Object.entries(data).forEach(function (_ref) {
        ...
        if (_typeof(value.value) == "object" && value.value != null && !(value.value instanceof Blob) && !(value.value instanceof Date)) {
    ...
    value: function setRules(rules) {
      ...
      Object.entries(rules).forEach(function (_ref3) {
        ...
        if (data[key] && typeof value == "string") {
          ...
          if (temp && _typeof(value) == "object" && _typeof(temp.value) == "object" && temp.value != null && !(temp.value instanceof Blob) && !(temp.value instanceof Date)) {
    ...
    value: function addProperties(data) {
      ...
      Object.entries(data).forEach(function (_ref7) {
        ...
        if (_typeof(value) == "object" && value != null && !(value instanceof Blob) && !(value instanceof Date)) {
          var nested = [];
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(_component_t_modal, {
    ...
    default: vue.withCtx(function () {
      return [vue.createVNode("div", _hoisted_1$2, [vue.createVNode("div", _hoisted_2$2, [_hoisted_3$2, vue.createVNode("div", _hoisted_4$2, [vue.createVNode("h3", _hoisted_5$2, [vue.renderSlot(_ctx.$slots, "title")]), vue.createVNode("div", _hoisted_6$2, [vue.renderSlot(_ctx.$slots, "content")])])])]), vue.createVNode("div", _hoisted_7$2, [vue.renderSlot(_ctx.$slots, "footer")])];
    }),
    _: 3
  ...
  setup: function setup(props, _ref) {
    ...
    var colunas = vue.computed(function () {
      return Object.entries(props.header).map(function (_ref2) {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("table", _hoisted_1$1, [vue.createVNode("thead", {
  ...
  }, null, 42, ["checked"])], 2)) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.colunas.filter(function (col) {
    return !col.abaixo;
  }), function (coluna) {
  ...
  }), 128))])], 2), (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.value, function (item, index) {
    ...
    }, null, 42, ["onChange", "checked"])], 2)) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.colunas.filter(function (col) {
      return !col.abaixo;
    }), function (coluna) {
    ...
    }), 128))], 10, ["onClick"]), _ctx.colunas.filter(function (col) {
      return !!col.abaixo;
    }).length > 0 ? (vue.openBlock(), vue.createBlock("tr", _hoisted_5$1, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.colunas.filter(function (col) {
      return !!col.abaixo && (typeof col.showCallback === 'function' ? col.showCallback(item) : true);
    }), function (coluna) {
      return vue.openBlock(), vue.createBlock("td", {
        key: "coluna-".concat(coluna.key),
        class: ["w-full text-gray-800 dark:text-gray-200 border border-b items-center relative", "".concat(_ctx.size == 'sm' && 'p-1', " ").concat(_ctx.size == 'base' && 'p-3', " ")],
        colspan: coluna.colspan || 1
      }, [vue.createVNode("div", _hoisted_6$1, [vue.createVNode("span", _hoisted_7$1, vue.toDisplayString(coluna.label), 1), vue.createVNode("div", _hoisted_8$1, [vue.renderSlot(_ctx.$slots, coluna.key, {
        $item: item
      }, function () {
        return [vue.createTextVNode(vue.toDisplayString(_ctx.checkItem(item[coluna.key])), 1)];
      })])])], 10, ["colspan"]);
